...
from ..utils import DoubleConv3DInstance

#  wersja dla glebokosci 5
...
#         # encoder layers
#         self.enc0_0 = DoubleConv3DInstance(in_channels, base_channels)
#         self.enc1_0 = DoubleConv3DInstance(base_channels, base_channels * 2)
#         self.enc2_0 = DoubleConv3DInstance(base_channels * 2, base_channels * 4)
#         self.enc3_0 = DoubleConv3DInstance(base_channels * 4, base_channels * 8)
#         self.enc4_0 = DoubleConv3DInstance(base_channels * 8, base_channels * 16)
...
#         self.dec3_1 = DoubleConv3DInstance(base_channels * 16, base_channels * 8)
#         self.dec2_1 = DoubleConv3DInstance(base_channels * 8, base_channels * 4)
#         self.dec2_2 = DoubleConv3DInstance(base_channels * 12, base_channels * 4)
#         self.dec1_1 = DoubleConv3DInstance(base_channels * 4, base_channels * 2)
#         self.dec1_2 = DoubleConv3DInstance(base_channels * 6, base_channels * 2)
#         self.dec1_3 = DoubleConv3DInstance(base_channels * 8, base_channels * 2)
#         self.dec1_4 = DoubleConv3DInstance(base_channels * 10, base_channels * 2)
#         self.dec0_1 = DoubleConv3DInstance(base_channels * 2, base_channels)
#         self.dec0_2 = DoubleConv3DInstance(base_channels * 3, base_channels)
#         self.dec0_3 = DoubleConv3DInstance(base_channels * 4, base_channels)
#         self.dec0_4 = DoubleConv3DInstance(base_channels * 5, base_channels)
