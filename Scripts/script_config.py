...
CALC_METRIC_REFERENCE_MASK_FOLDER = BASE_DIR / "Data" / "CleanToothFairy2" / "labelsTeethAll" / "test"
CALC_METRIC_PREDICTION_MASK_FOLDER = BASE_DIR / "Results" / "UnetPP3D_ToothFairy2"
CALC_METRIC_EXTENSION = ".mha"
CALC_METRIC_CLASS_NUMBER = 9
