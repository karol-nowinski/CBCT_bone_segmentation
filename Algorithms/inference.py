...
class UnetInference:
    ...
    def predict_subject(self,subject):
        '''
        Metoda wykonująca inferencje przekazanego subjectu (obrazu medycznego).
    ...
    def predict_and_save(self,image_path,output_path,save=True):
        '''
        Główna metoda służąca do predykcji segmentacji wraz z zapisanie.
        '''
        subject = tio.Subject(
        ...
        print("Unikalne klasy:", segmentation.unique())
        ...
        if save:
            ...
            print("Segmentacja zapisana: ", output_path)
